...
var cuteAnimals = ["cat", "dog", "horse", "bird", "monkey"]
...
var foodDictionary = ["Anchovies": true, "Coconut": false, "Cilantro": false, "Liver": true]
...
//var presidentialDogs = ["Michele Obama": "Bo"]
if let dogs = presidentialDogs["Michele Obama"]{
    print("Michele Obama walks \(dogs) every morning.")
} else{
...
var countAlbums = studioAlbums.count
print(countAlbums)